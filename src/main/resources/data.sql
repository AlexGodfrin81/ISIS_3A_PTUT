...
INSERT INTO Animal(id_animal, nom, espece, est_Male, date_naiss, taille_cm, nec, proprio, marace, monactivite, monstadephysio) VALUES
    (1, 'Hilda', 'CHIEN', false, '2012-03-01', 100, 3, 3, 1, 2, 2),
    (2, 'Papouille', 'CHIEN', true, '2005-06-05', 45, 7, 1, 2, 1, 1);
...
INSERT INTO Proprietaire(id_proprio, nom, prenom, tel, mail) VALUES 
    ...
    (3, 'Viemon-Desplanque', 'Joffrey', '0667930794', 'joffrey.viemon-desplanque@etud.univ-jfc.fr');
