...
public class Animal {
    ...
    /**
     * Calcule le poids idéal de l'animal en fonction de son nec et de ses
     * anciens poids
     *
     * @return un float équivalent au poids idéal
     */
     ...
     *
     * @return le besoin énergétique, en fonction du coefficient K et du besoin
     * énergétique à l'entretien
     */
